...
export default function SurahDetailScreen() {
  ...
  const onPlaybackStatusUpdate = (status: any) => {
    if (!status.isLoaded) {
      if (status.error) {
        ...
        Alert.alert('Playback Error', 'Could not play audio. Please try another reciter.');
      }
      return;
    }
  ...
  const loadAudio = async (verseNumber?: number) => {
    try {
      ...
      Alert.alert('Error', 'Could not play audio. Please try another reciter or check your internet connection.');
    }
  };
      ...
      <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
        ...
        <Card >
          <View style={styles.reciterHeader}>
            ...
            >
              <Text style={[styles.reciterChangeText, { color: colors[theme].primary }]}>
                Change
              </Text>
            </TouchableOpacity>
          </View>
              ...
              <View style={styles.progressBarContainer}>
                ...
                <TouchableOpacity 
                  ...
                  onPress={(e) => {
                    ...
                    const progressWidth = e.currentTarget.measure((x, y, width, height) => {
          ...
          <View style={styles.playbackControls}>
            <TouchableOpacity onPress={skipBackward} style={styles.controlButton}>
              ...
              <Text style={[styles.controlText, { color: colors[theme].primary }]}>10s</Text>
            </TouchableOpacity>
            
            <TouchableOpacity 
              onPress={togglePlayPause} 
              style={[styles.playPauseButton, { backgroundColor: colors[theme].primary }]}
            >
              {isPlaying ? (
            ...
            <TouchableOpacity onPress={skipForward} style={styles.controlButton}>
              <Text style={[styles.controlText, { color: colors[theme].primary }]}>10s</Text>
              <RotateCcw size={24} color={colors[theme].primary} style={{ transform: [{ scaleX: -1 }] }} />
            </TouchableOpacity>
          </View>
        </Card>
        ...
        <View style={styles.settingsBar}>
          <TouchableOpacity 
            style={[
              ...
              showTranslation && [styles.settingButtonActive, themeStyles.settingButtonActive]
            ]}
          ...
          >
            <Text style={[
              ...
              showTranslation && [styles.settingButtonTextActive, themeStyles.settingButtonTextActive]
            ]}>
              Translation
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity 
            style={[
              styles.settingButton, 
              themeStyles.settingButton,
              showTransliteration && [styles.settingButtonActive, themeStyles.settingButtonActive]
            ]}
          ...
          >
            <Text style={[
              styles.settingButtonText, 
              themeStyles.settingButtonText,
              showTransliteration && [styles.settingButtonTextActive, themeStyles.settingButtonTextActive]
            ]}>
              Transliration
            </Text>
          </TouchableOpacity>
          ...
          <View style={styles.fontSizeControl}>
            ...
            >
              <Text style={{ color: colors[theme].text, fontSize: 16 }}>A-</Text>
            </TouchableOpacity>
            ...
            <Card key={index} >
              <View style={styles.verseHeader}>
                ...
                <View style={styles.verseActions}>
                  <TouchableOpacity 
                    style={[styles.verseActionButton, themeStyles.verseActionButton]}
        ...
        >
          <View style={[styles.reciterModal, { backgroundColor: 'rgba(0, 0, 0, 0.5)' }]}>
            <View style={[styles.reciterModalContent, { backgroundColor: colors[theme].card }]}>
              <Text style={[styles.reciterModalTitle, { color: colors[theme].text }]}>
                Select Reciter
              </Text>
                ...
                {quranReciters.map(reciter => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      selectedReciter.id === reciter.id && [styles.reciterOptionSelected, { backgroundColor: colors[theme].primary + '20' }]
                    ]}
                  ...
                  >
                    <Text style={[
                      styles.reciterName, 
                      { color: colors[theme].text },
                      selectedReciter.id === reciter.id && { color: colors[theme].primary, fontWeight: 'bold' }
                    ]}>
                      {reciter.name}
                    </Text>
                  </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[styles.closeButton, { backgroundColor: colors[theme].primary }]}
