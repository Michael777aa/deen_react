...
import { MapPin, Phone, Clock, Globe, Star, ChevronLeft, Share2, Heart, ExternalLink } from 'lucide-react-native';
      ...
      >
        <View style={styles.infoContainer}>
          ...
          <View style={styles.metaContainer}>
            <View style={[styles.certificationBadge, { backgroundColor: colors[theme].primary + '20' }]}>
              <Text style={[styles.certificationText, { color: colors[theme].primary }]}>
                {restaurant.certification}
              </Text>
            </View>
            <Text style={[styles.cuisineText, { color: colors[theme].inactive }]}>
              {restaurant.cuisine}
            </Text>
          ...
          <View style={styles.ratingContainer}>
            {[1, 2, 3, 4, 5].map((star) => (
              <Star 
                key={star}
                size={16} 
                fill={star <= restaurant.rating ? colors[theme].primary : 'transparent'} 
                color={star <= restaurant.rating ? colors[theme].primary : colors[theme].inactive} 
              />
            ))}
          ...
          <Card style={styles.contactCard}>
            ...
            {restaurant.phone && (
              <TouchableOpacity style={styles.contactItem} onPress={callRestaurant}>
            ...
            {restaurant.website && (
              <TouchableOpacity style={styles.contactItem} onPress={visitWebsite}>
          ...
          <Card style={styles.photosCard}>
            ...
            >
              <Image 
                source={{ uri: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' }} 
                style={styles.photoItem}
              />
              <Image 
                source={{ uri: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' }} 
                style={styles.photoItem}
              />
              <Image 
                source={{ uri: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' }} 
                style={styles.photoItem}
              />
            </ScrollView>
          </Card>
          ...
          <View style={styles.actionButtons}>
            ...
            <TouchableOpacity 
              style={[styles.favoriteButton, { backgroundColor: colors[theme].card }]}
            >
            ...
            {restaurant.phone && (
              <TouchableOpacity 
                style={[styles.callButton, { backgroundColor: colors[theme].card }]}
