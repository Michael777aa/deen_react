      ...
      <View style={[styles.container, { backgroundColor: colors[theme].background }]}>
        ...
        <View style={styles.mapContainer}>
          {isLoading ? (
            ...
            Platform.OS === 'web' ? (
              <View style={[styles.webMapPlaceholder, { backgroundColor: colors[theme].card }]}>
                <Text style={[styles.webMapText, { color: colors[theme].text }]}>
                  Map view is not available on web.
                </Text>
                <Text style={[styles.webMapSubtext, { color: colors[theme].inactive }]}>
              ...
              >
                ...
                {restaurants.slice(0, 5).map((restaurant, index) => (
                  ...
                  >
                    ...
                    <Text style={[styles.restaurantMarkerText, { color: colors[theme].text }]}>
                      {restaurant.name}
                    </Text>
                  </TouchableOpacity>
                ))}
